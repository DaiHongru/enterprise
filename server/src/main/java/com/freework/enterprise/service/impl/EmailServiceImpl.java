...
import com.freework.enterprise.producer.EmailSender;
import com.freework.enterprise.service.EmailService;
import com.freework.enterprise.service.EnterpriseService;
import com.freework.enterprise.service.MessageLogService;
...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendVerificationEmail(String address) {
        ...
        messageLog.setTag("EnterpriseEmail");
    ...
    @Async
    @Override
    public void sendActivatedMail(Enterprise enterprise) {
        Integer id = enterprise.getEnterpriseId();
        String code = getCodeString(16).toString();
        String key = EnterpriseService.ENTERPRISE_EMAIL_ACTIVATION_CODE_KEY + "_Id_" + id;
        ...
        String htmlText = "<html lang=\"zh-CN\">\n" +
                ...
                "<a target=\"_blank\" href=\"http://101.132.152.64/html/enterprise/activationemail.html?id=" + id + "&code=" + code + "\">" +
                "http://101.132.152.64/html/enterprise/activationemail.html?id=" + id + "&code=" + code +
                "</a>\n" +
                ...
                "</html>";
        EmailVo emailVo = new EmailVo();
        emailVo.setAddress(enterprise.getEmail());
        emailVo.setHtmlText(htmlText);
        emailVo.autoSetMessageId();
        MessageLog messageLog = new MessageLog();
        messageLog.setTag("EnterpriseEmail");
